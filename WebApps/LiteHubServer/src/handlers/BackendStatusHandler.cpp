...
void BackendStatusHandler::handle(const http::HttpRequest &req, http::HttpResponse *resp)
{
    ...
    try
    {
        ...
        std::string reqFile("../WebApps/LiteHubServer/resource/backend_status.html");
